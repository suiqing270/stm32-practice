...
#define ComConf_ComSignal_CrashIntensity_omsg_Receive_oCAN00_57f27485_Rx 0u
#define ComConf_ComSignal_EmergencyBrakeLight_omsg_Receive_oCAN00_5282eb8e_Rx 1u
#define ComConf_ComSignal_HazardSw_omsg_Receive_oCAN00_578d9c4d_Rx    2u
#define ComConf_ComSignal_IGN_Status_omsg_Receive_oCAN00_593fdbd9_Rx  3u
#define ComConf_ComSignal_TurnLampFb_FL_omsg_Receive_oCAN00_3ab29a6d_Rx 4u
#define ComConf_ComSignal_TurnLampFb_FR_omsg_Receive_oCAN00_a2998431_Rx 5u
#define ComConf_ComSignal_TurnLampFb_RL_omsg_Receive_oCAN00_cfe4432c_Rx 6u
#define ComConf_ComSignal_TurnLampFb_RR_omsg_Receive_oCAN00_57cf5d70_Rx 7u
#define ComConf_ComSignal_TurnLampSw_omsg_Receive_oCAN00_92b10255_Rx  8u
#define ComConf_ComSignal_VehicleSpeed_Valid_omsg_Receive_oCAN00_6a5f4ba3_Rx 9u
#define ComConf_ComSignal_VehicleSpeed_omsg_Receive_oCAN00_e95dd8a1_Rx 10u
#define ComConf_ComSignal_sig_State_RearInteriorLight_omsg_Receive_oCAN00_63323183_Rx 11u
#define ComConf_ComSignal_sig_State_RearLeftDoor_omsg_Receive_oCAN00_84ad4140_Rx 12u
#define ComConf_ComSignal_sig_State_RearRightDoor_omsg_Receive_oCAN00_a8945098_Rx 13u
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define ComConf_ComSignal_LA_St_DirectionLampL_omsg_Transmit_oCAN00_c218ca04_Tx 0u
#define ComConf_ComSignal_LA_St_DirectionLampR_omsg_Transmit_oCAN00_a05dfcc5_Tx 1u
#define ComConf_ComSignal_sig_LampCnt_omsg_MyECU_Lamp_oCAN00_f37e68ea_Tx 2u
#define ComConf_ComSignal_sig_RearInteriorLight_omsg_Transmit_oCAN00_49a633c1_Tx 3u
/**\} */
...
#define Com_GetSizeOfRxAccessInfoIndOfPCConfig()                      14u  /**< the number of accomplishable value elements in Com_RxAccessInfoInd */
#define Com_GetSizeOfRxAccessInfoOfPCConfig()                         14u  /**< the number of accomplishable value elements in Com_RxAccessInfo */
#define Com_GetSizeOfRxDefPduBufferOfPCConfig()                       8u  /**< the number of accomplishable value elements in Com_RxDefPduBuffer */
...
#define Com_GetSizeOfRxSigBufferUInt8OfPCConfig()                     13u  /**< the number of accomplishable value elements in Com_RxSigBufferUInt8 */
#define Com_GetSizeOfRxSigInfoOfPCConfig()                            14u  /**< the number of accomplishable value elements in Com_RxSigInfo */
#define Com_GetSizeOfTxBufferOfPCConfig()                             10u  /**< the number of accomplishable value elements in Com_TxBuffer */
...
#define Com_GetSizeOfTxPduInitValueOfPCConfig()                       10u  /**< the number of accomplishable value elements in Com_TxPduInitValue */
...
#define Com_GetPduGrpVectorEndIdxOfRxPduGrpInfo(Index)                ((Com_PduGrpVectorEndIdxOfRxPduGrpInfoType)((((Com_PduGrpVectorEndIdxOfRxPduGrpInfoType)(Index)) + 1u)))  /**< the end index of the 0:n relation pointing to Com_PduGrpVector */
...
#define Com_GetRxAccessInfoIndEndIdxOfRxPduInfo(Index)                ((Com_RxAccessInfoIndEndIdxOfRxPduInfoType)((((Com_RxAccessInfoIndEndIdxOfRxPduInfoType)(Index)) + 14u)))  /**< the end index of the 0:n relation pointing to Com_RxAccessInfoInd */
...
#define Com_GetRxDefPduBufferLengthOfRxPduInfo(Index)                 ((Com_RxDefPduBufferLengthOfRxPduInfoType)((((Com_RxDefPduBufferLengthOfRxPduInfoType)(Index)) + 8u)))  /**< the number of relations pointing to Com_RxDefPduBuffer */
...
#define Com_GetRxSigInfoEndIdxOfRxPduInfo(Index)                      ((Com_RxSigInfoEndIdxOfRxPduInfoType)((((Com_RxSigInfoEndIdxOfRxPduInfoType)(Index)) + 14u)))  /**< the end index of the 0:n relation pointing to Com_RxSigInfo */
...
{
  Com_RxDefPduBufferType msg_Receive_oCAN00_2b456e3f_Rx[8];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Com_RxAccessInfoType, COM_CONST) Com_RxAccessInfo[14];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Com_RxSigInfoType, COM_CONST) Com_RxSigInfo[14];
#define COM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Com_TxPduInitValueType, COM_CONST) Com_TxPduInitValue[10];
#define COM_STOP_SEC_CONST_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(Com_RxSigBufferUInt8Type, COM_VAR_NOINIT) Com_RxSigBufferUInt8[13];
#define COM_STOP_SEC_VAR_NOINIT_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(Com_TxBufferType, COM_VAR_NOINIT) Com_TxBuffer[10];
#define COM_STOP_SEC_VAR_NOINIT_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
