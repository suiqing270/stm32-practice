...
VAR(uint8, RTE_VAR_NOINIT) Rte_TurnLightAct_CountSignal_Left_u8_Signal; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
VAR(uint8, RTE_VAR_NOINIT) Rte_TurnLightAct_CountSignal_Right_u8_Signal; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
VAR(uint8, RTE_VAR_NOINIT) Rte_TurnLightAct_TurnLampCtrlCmd_FL_u8_signal; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
VAR(uint8, RTE_VAR_NOINIT) Rte_TurnLightAct_TurnLampCtrlCmd_FR_u8_signa; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
VAR(uint8, RTE_VAR_NOINIT) Rte_TurnLightAct_TurnLampCtrlCmd_RL_u8_signal; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
VAR(uint64, RTE_VAR_NOINIT) Rte_TurnLightAct_TurnLampCtrlCmd_RR_u8_signal; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
VAR(uint8, RTE_VAR_NOINIT) Rte_TurnLightArb_TurnLamp_FL_Out_u8_Signal; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
VAR(uint8, RTE_VAR_NOINIT) Rte_TurnLightArb_TurnLamp_RL_Out_u8_Signal; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
VAR(uint8, RTE_VAR_NOINIT) Rte_TurnLightArb_TurnLapm_FR_Out_u8_Signal; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
VAR(uint8, RTE_VAR_NOINIT) Rte_TurnLightArb_TurnLapme_RR_Out_u8_Signal; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Start(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
  ...
  Rte_TurnLightAct_CountSignal_Left_u8_Signal = 0U;
  Rte_TurnLightAct_CountSignal_Right_u8_Signal = 0U;
  Rte_TurnLightAct_TurnLampCtrlCmd_FL_u8_signal = 0U;
  Rte_TurnLightAct_TurnLampCtrlCmd_FR_u8_signa = 0U;
  Rte_TurnLightAct_TurnLampCtrlCmd_RL_u8_signal = 0U;
  Rte_TurnLightAct_TurnLampCtrlCmd_RR_u8_signal = 0ULL;
  Rte_TurnLightArb_TurnLamp_FL_Out_u8_Signal = 0U;
  Rte_TurnLightArb_TurnLamp_RL_Out_u8_Signal = 0U;
  Rte_TurnLightArb_TurnLapm_FR_Out_u8_Signal = 0U;
  Rte_TurnLightArb_TurnLapme_RR_Out_u8_Signal = 0U;
  ...
  (void)SetRelAlarm(Rte_Al_TE_OsTask_BSW_SCHM_0_10ms, RTE_MSEC_SystemTimer(0) + (TickType)1, RTE_MSEC_SystemTimer(10)); /* PRQA S 3417 */ /* MD_Rte_Os */
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Stop(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
  ...
  (void)CancelAlarm(Rte_Al_TE_OsTask_BSW_SCHM_0_10ms); /* PRQA S 3417 */ /* MD_Rte_Os */
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Write_TurnLightAct_Com_CAN_LA_St_DirectionLampL_u8_signal(uint8 data) /* PRQA S 0850, 1505 */ /* MD_MSR_19.8, MD_MSR_8.10 */
{
  Std_ReturnType ret = RTE_E_OK;

  ret |= Com_SendSignal(ComConf_ComSignal_LA_St_DirectionLampL_omsg_Transmit_oCAN00_c218ca04_Tx, (&data)); /* PRQA S 0850 */ /* MD_MSR_19.8 */

  return ret;
} /* PRQA S 6010, 6030, 6050 */ /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STCAL */

FUNC(Std_ReturnType, RTE_CODE) Rte_Write_TurnLightAct_Com_CAN_LA_St_DirectionLampR_u8_signal(uint8 data) /* PRQA S 0850, 1505 */ /* MD_MSR_19.8, MD_MSR_8.10 */
{
  Std_ReturnType ret = RTE_E_OK;

  ret |= Com_SendSignal(ComConf_ComSignal_LA_St_DirectionLampR_omsg_Transmit_oCAN00_a05dfcc5_Tx, (&data)); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
TASK(OsTask_BSW_SCHM) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
  ...
  for(;;)
  {
    (void)WaitEvent(Rte_Ev_Cyclic2_OsTask_BSW_SCHM_0_10ms | Rte_Ev_Cyclic2_OsTask_BSW_SCHM_0_20ms | Rte_Ev_Cyclic_OsTask_BSW_SCHM_0_10ms | Rte_Ev_Run_CanTp_CanTp_MainFunction); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)GetEvent(OsTask_BSW_SCHM, &ev); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)ClearEvent(ev & (Rte_Ev_Cyclic2_OsTask_BSW_SCHM_0_10ms | Rte_Ev_Cyclic2_OsTask_BSW_SCHM_0_20ms | Rte_Ev_Cyclic_OsTask_BSW_SCHM_0_10ms | Rte_Ev_Run_CanTp_CanTp_MainFunction)); /* PRQA S 3417 */ /* MD_Rte_Os */
    ...
    if ((ev & Rte_Ev_Cyclic_OsTask_BSW_SCHM_0_10ms) != (EventMaskType)0)
    {
      /* call runnable */
