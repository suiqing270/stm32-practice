...
//代表无参数、无返回值的函数 统一封装所有业务函数 方便统一传递和调用
...
void app_init(void)
{
    ...
    //其他定时器用 work_timer_cb 丢工作队列
    time_sync_timer = xTimerCreate("time sync",pdMS_TO_TICKS(200),pdTRUE,time_sync,work_timer_cb);
